...
#jhona
from   goamazon.Parameters_forcing_iop import shca,trop_atm,mls_atm,hgt_std
...
#shca = Dataset("../../data/raw_case_input/SHCA/amazon_shcu.nc", 'r')


case_period_labels = ['A']#,'B','C','R','S','T','U','X']

case_period_start_datetimes = [datetime.datetime(2014,1,1 ,hour=00),
                              ]
case_period_end_datetimes =   [datetime.datetime(2014,1,2 ,hour=23),
                              ]
...
base_time   = nc_fid.variables['tsec'][:]
